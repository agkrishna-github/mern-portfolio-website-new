          ...
          >
            ...
            >
              ...
              <div
                className={
                  value
                    ? "flex flex-col md:flex-row justify-center items-center gap-5  p-3  fixed  right-5   bottom-5 md:left-4 bg-[rgba(131,133,227,0.4)] text-xl rounded-xl z-10 "
                    : "hidden"
                }
              >
                <Link
            ...
            <section className="md:w-full p-5 md:p-2 w-full h-full flex flex-col justify-normal gap-5 md:gap-2 relative -translate-y-16 ">
              <div className="w-[480px] md:w-[300px] p-5 m-auto h-[81%] md:h-[300px] md:-translate-y-8 shadow-[0px_5px_15px_rgba(0,0,0,0.35)] flex justify-center items-center rounded rotate-45  md:rotate-0">
                <div className="w-[80%] md:w-[200px] h-[80%] md:h-[200px] bg-gradient-to-r py-12 from-[#E0C3FC] to-[#091e79] rotateDiv"></div>
              </div>
              <div className="w-[400px] md:w-[200px] h-[300px] md:h-[200px] md:pb-0 absolute md:-translate-y-16 top-[20%] left-[150px] md:left-[100px]">
                <img
